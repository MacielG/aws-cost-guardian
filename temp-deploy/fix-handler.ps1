$filePath = "G:\aws-cost-guardian\backend\handler.js"
$content = Get-Content $filePath -Raw

# Encontrar e substituir a função /api/onboard-init completa
$oldFunction = @'
...
Write-Host "✅ Handler.js corrigido!"
Write-Host "Verificando sintaxe..."
node -c "G:\aws-cost-guardian\backend\handler.js"
